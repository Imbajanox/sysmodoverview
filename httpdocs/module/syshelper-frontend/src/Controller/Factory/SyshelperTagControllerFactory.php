...
use WirklichDigital\SyshelperFrontend\Controller\SyshelperTagController;
...
class SyshelperTagControllerFactory implements FactoryInterface
{
    ...
    public function __invoke(\Interop\Container\ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new SyshelperTagController($em, $formManager, $dataTableApi);
    }
}
