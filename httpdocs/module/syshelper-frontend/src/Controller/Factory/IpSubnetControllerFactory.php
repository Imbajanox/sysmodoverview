...
use WirklichDigital\SyshelperFrontend\Controller\IpSubnetController;
...
class IpSubnetControllerFactory implements FactoryInterface
{
    ...
    public function __invoke(\Interop\Container\ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new IpSubnetController($em, $formManager, $dataTableApi);
    }
}
