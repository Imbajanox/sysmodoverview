...
class IpSubnetFieldset extends Fieldset implements InputFilterProviderInterface, UseDoctrineHydrator, LazyAddInterface, ObjectManagerAwareInterface
{
    ...
    public function init()
    {
        ...
        $this->add([
            ...
            'options'    => [
                ...
                'label'             => gettext_noop('Syshelper Tags'),
            ],
        ]);
    }
