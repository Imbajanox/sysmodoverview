...
class SshPublicKeyForm extends Form implements TranslationInfoAwareInterface
{
    ...
    public function init()
    {
        ...
        $this->add([
            'name' => 'SshPublicKey',
            'type' => SshPublicKeyFieldset::class,
            'options' => [
